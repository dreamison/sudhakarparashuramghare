  ...
  return (
    <div className="my-2">
      ...
      <p className="text-center">
        ...
        >
          डेमो मतदानासाठी ऑटो रिक्शा चिन्हासमोरील बटन दाबा
        </button>
      </p>
      <div className="text-center mb-3 d-flex justify-content-center">
        <button className="btn btn-warning btn-sm mx-1 text-white p-1" style={{ background: '#ff6634', fontSize: '10px', fontWeight: '800', padding: '0px' }}>
          मतदानाच्या दिवशी ऑटो रिक्शा चिन्हासमोरील बटन दाबा
        </button>
        <Button
        ...
        >
          ...
          >
            ...
            >
              ...
              <h3 className="text-white p-1" style={{ fontSize: '12px', zIndex: 100 }}>कृपया स्लिपची पडताळणी करा / Please verify slip <br></br> मतदानाच्या दिवशी सुद्धा "ऑटो रिक्शा" चिन्हा <br></br>समोरील बटण दाबावे</h3>
            </div>
          </div>
        </div>
      )}
